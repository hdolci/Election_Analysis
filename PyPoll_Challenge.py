...
with open(file_to_save, "w") as txt_file:
    ...
    # 6f: Write an if statement to determine the winning county and get its vote count.
        if (cvotes > largest_county_votes) and (cvotes_percentage > largest_county_percentage):
    ...
    largest_county_summary = (
        ...
        f"-------------------------\n")
    # f"\n{largest_county} Vote Count: {largest_county_votes:,}\n"
    # f"\n{largest_county}'s Percentage of votes: {largest_county_percentage:.1f}%\n"
    # f"\n-------------------------\n")
